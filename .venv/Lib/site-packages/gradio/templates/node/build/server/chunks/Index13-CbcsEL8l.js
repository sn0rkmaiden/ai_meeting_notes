...
import { B as Block, S as Static, f as BlockLabel, Q as Code$2, h as Empty, j as IconButton, z as Copy$1, D as DownloadLink, k as Download$1, i as IconButtonWrapper, V as getWorkerProxyContext } from './2-CGsk4wvi.js';
...
const lang_map = {
  python: () => import('./index29-PkswuQ6B.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index30-ClCRK5Uv.js'),
      import('./frontmatter-C-bU-P9U.js')
    ]);
    return md.markdown({ extensions: [frontmatter.frontmatter] });
  },
  json: () => import('./index34-CJhyeEhb.js').then((m) => m.json()),
  html: () => import('./index31-BeozdDt9.js').then((m) => m.html()),
  css: () => import('./index32-GP96Fa0I.js').then((m) => m.css()),
  javascript: () => import('./index33-TWEmGSRr.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index33-TWEmGSRr.js').then(
...
//# sourceMappingURL=Index13-CbcsEL8l.js.map
